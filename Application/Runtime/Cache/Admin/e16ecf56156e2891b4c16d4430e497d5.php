...
<div class="sidebar">
    <div class="sidebar-menu">
        ...
        <div class="showlistsort main">
            ...
            <h1>当前列表分类为：<?php echo ($articlesortnamestr); ?></h1>

            <a class="addnew" href="<?php echo U('/Admin/Article/addarticle');?>">写文章</a>
            ...
            <?php if(!empty($articlelistsort)): ?><div class="listarticle">
                <?php if(is_array($articlelistsort)): $k = 0; $__LIST__ = $articlelistsort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="every-article">
                    ...
                    <!-- 修改、删除按钮 -->
                    <div class="operate">
                        <a href="<?php echo U('/Admin/Article/modifyarticle',array('id'=>$vo['id']));?>">
