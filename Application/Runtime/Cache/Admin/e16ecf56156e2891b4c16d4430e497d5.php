...
<head>
    ...
    <title>挺 | 后台管理 - <?php echo ($articlesortnamestr); ?> - 文章列表</title>
...
<div class="sidebar">
    <div class="sidebar-menu">
        ...
        <div class="showlistsort main">
            ...
            <h1>当前列表分类为：<?php echo ($articlesortnamestr); ?>(<?php echo ($count); ?>)</h1>

            <a class="addnew" href="<?php echo U('/Admin/Article/addarticle',array('issorttag'=>'1','sortidvalue'=>$sortid));?>">写文章</a>

            <?php if(!empty($articlelistsort)): ?><div class="listarticle">
                <?php if(is_array($articlelistsort)): $k = 0; $__LIST__ = $articlelistsort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="every-article">
                    <!-- 文章封面 -->
                    ...
                    <!-- 修改、删除按钮 -->
                    <div class="operate">
                        <a href="<?php echo U('/Admin/Article/modifyarticle',array('issorttag'=>'1','sortidvalue'=>$vo['sortid'],'id'=>$vo['id']));?>">
            ...
            <?php if(empty($articlelistsort)): ?><div class="emptydata"><p>还没有文章噢，快写篇文章吧~</p></div><?php endif; ?>
        </div>      
