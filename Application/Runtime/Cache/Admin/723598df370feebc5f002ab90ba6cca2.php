...
<head>
    ...
    <title>挺 | 后台管理 - <?php echo ($articletagnamestr); ?> - 文章列表</title>
...
<div class="sidebar">
    <div class="sidebar-menu">
        ...
        <div class="showlisttag main">
            ...
            <h1>当前列表标签为：<?php echo ($articletagnamestr); ?>(<?php echo ($count); ?>)</h1>

            <a class="addnew" href="<?php echo U('/Admin/Article/addarticle',array('issorttag'=>'2','tagidvalue'=>$tagid));?>">写文章</a>

            <?php if(!empty($articlelisttag)): ?><div class="listarticle">
                <?php if(is_array($articlelisttag)): $k = 0; $__LIST__ = $articlelisttag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="every-article">
                    <!-- 文章封面 -->
                    ...
                    <!-- 修改、删除按钮 -->
                    <div class="operate">
                        <a href="<?php echo U('/Admin/Article/modifyarticle',array('issorttag'=>'2','tagidvalue'=>$tagid,'id'=>$vo['id']));?>">
            ...
            <?php if(empty($articlelisttag)): ?><div class="emptydata"><p>还没有文章噢，快写篇文章吧~</p></div><?php endif; ?>
        </div>
