...
<div class="sidebar">
    <div class="sidebar-menu">
        ...
        <div class="addsort main">
            <h1>正在新增分类...</h1>

            <div class="cancel-area">
                <a class="publish-cancel" href="<?php echo U('/Admin/Sort/showlist');?>">取消新增</a>
            </div>

            <div class="addmodify-sorttag">
                <form action="<?php echo U('/Admin/Sort/addsort');?>" method="post" enctype="multipart/form-data">
                    <p class="addmodify-srottag-input">
                        <span class="sorttag-name">分类名称</span>
                        <input class="sorttag-input" type="text" name="sortname" placeholder="填写一个分类名称" />
                    </p>
